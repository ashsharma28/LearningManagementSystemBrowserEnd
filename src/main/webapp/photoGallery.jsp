            ...
            <section>
                ...
                <div class="row 200%">
					...
					<%
						...
						ResultSet resultSet = controller.getFiles(con, "Select * from gallery ");

						try {
							out.append("<div class=\"box alt\">\n" + "<div class=\"row 50% uniform\">");



							while (resultSet.next()){
								out.append("<div class=\"4u\"><span class=\"image fit\"><img src=\"");
								out.append(resultSet.getString(3));
								out.append("\" width=\"300\" height==\"300\"  alt=\""+ resultSet.getString(2) +"\" /></span></div>");
							}
