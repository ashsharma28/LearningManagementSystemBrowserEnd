        ...
        <div class="row 200%">
          ...
          <div class="table-wrapper">
            ...
            <%
              ...
              ResultSet resultSet = controller.getFiles(con, "Select * from homework where cls = \"" + Class +"\"");

              try {

                if(!resultSet.next()){
                  out.append("<h2>No data available!</h2");
                }
                else{
                  ...
                  while (resultSet.next()){
                    ...
                    out.append("<td>");
                    out.append("<a href=\"\\"+resultSet.getString(4) + "\" >"+resultSet.getString(4).replace("data/" , "")+"</a>  ");
                    out.append("</td>");
